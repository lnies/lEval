...
from read_write_functions2 import *
...
# Variables to change:
# ------------------------
file_path = 'E:\\Welker\\harmonizing' # 'G:\\Experiments\\ISOLTRAP\\DATA\\2017\\2017-07-Xe-Cs-run-prep\\analyzed\\2017-07-16-85Rb-nuamp-133Cs_run20' # 'G:\\Experiments\\ISOLTRAP\\DATA\\2017\\Screenshots\\2017-06' # '/Volumes/dfs/USER/Karthein_Jonas/harm-new' # 'G:\\Experiments\\ISOLTRAP\\DATA\\2017\\2017-06-tests' #'/Volumes/dfs/DATA/2017/2017-04-tuning/' # 'G:\\Experiments\\ISOLTRAP\\DATA\\2017\\2017-05_ArKr_run'
...
file_name = 'Harmoni_magnetron'  # name of the excel sheet without the ending .xlsx
title = 'Efield harmonization with $^{85}$Rb' # '$^{85}$Rb$^+$ mag amp in PI-ICR'      # if you don't need it, leave it empty like ''
...
fit_function = 'x^4'   # chose from: 'linear', 'gauss', 'x^2', 'x^4', 'exp', 'sin'
font = 'Utopia'        # chose from: 'LaTeX' = Computer Modern Serif or 'Utopia' = \\usepackage{fourier}
color_points = 'black'      # chose from: 'green', 'blue', 'yellow', 'black', 'red'
