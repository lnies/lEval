...
# Variables to change:
# ------------------------
file_path = 'E:\\Welker\\axial_motion_scan' # 'G:\\Experiments\\ISOLTRAP\\DATA\\2017\\2017-07-Xe-Cs-run-prep\\analyzed\\2017-07-16-85Rb-nuamp-133Cs_run20' # 'G:\\Experiments\\ISOLTRAP\\DATA\\2017\\Screenshots\\2017-06' # '/Volumes/dfs/USER/Karthein_Jonas/harm-new' # 'G:\\Experiments\\ISOLTRAP\\DATA\\2017\\2017-06-tests' #'/Volumes/dfs/DATA/2017/2017-04-tuning/' # 'G:\\Experiments\\ISOLTRAP\\DATA\\2017\\2017-05_ArKr_run'
...
file_name = 'axial_mean_tof_width'  # name of the excel sheet without the ending .xlsx
title = 'Minimizing the axial motion ' # '$^{85}$Rb$^+$ mag amp in PI-ICR'      # if you don't need it, leave it empty like ''
